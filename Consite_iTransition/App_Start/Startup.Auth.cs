...
using Owin;
using Consite_iTransition.Models;
    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseVkontakteAuthentication(
                    appId: "5834176",
                    appSecret: "gqWy9TS48Br1rEuiP0e6",
                    scope: "pages");
            ...
            app.UseFacebookAuthentication(
               appId: "1849464248675636",
               appSecret: "17ac88e0264362f2691e6f1235b668e1");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "119439018501-8i2ejvmk4t7bcpk109nsogm8kj6jk97m.apps.googleusercontent.com",
                ClientSecret = "4qBG4jBFpeWopxqeWO6WZ-yU"
            });
        }
    }
}